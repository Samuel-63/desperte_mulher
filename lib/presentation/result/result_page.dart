...
class ResultPage extends ConsumerWidget {
  ...
  List<String> get _recommendations => switch (_level) {
        RiskLevel.extreme => [
            ...
            'Acione sua rede de apoio agora',
          ],
        RiskLevel.high => [
              ...
              child: Column(
                children: [
                  Container(
                    ...
                    child: Center(
                      child: Icon(_iconForLevel(level), color: color, size: 40),
                    ),
                  ),
                  const SizedBox(height: AppSpacing.md),
                  Text('Nível de Risco',
                      style: AppTypography.bodySmall
                          .copyWith(color: AppColors.textHint, letterSpacing: 2)),
                  ...
                  Text('$score% de risco identificado',
                ...
                children: [
                  Row(
                    children: [
                      ...
                      Text('Recomendações', style: AppTypography.headlineLarge),
                    ],
                  ),
                ...
                child: Column(
                  children: [
                    const Icon(Icons.emergency,
                        color: AppColors.riskExtreme, size: 32),
                    const SizedBox(height: AppSpacing.sm),
                    Text('Contatos de Emergência',
                        style: AppTypography.headlineLarge
                            .copyWith(color: AppColors.riskExtreme)),
                    const SizedBox(height: AppSpacing.lg),
                    _EmRow(number: '180', label: 'Central de Atendimento à Mulher'),
                    const SizedBox(height: AppSpacing.sm),
                    _EmRow(number: '190', label: 'Polícia Militar'),
                    const SizedBox(height: AppSpacing.sm),
                    _EmRow(number: '(63) 99282-0574', label: 'Ouvidoria da Mulher TO'),
                  ],
                ),
              ),
            ],
...
class _EmRow extends StatelessWidget {
  final String number;
  final String label;
  const _EmRow({required this.number, required this.label});
            ...
            children: [
              Text(number,
                  style: AppTypography.headlineMedium
                      .copyWith(color: AppColors.riskExtreme, fontWeight: FontWeight.w900)),
