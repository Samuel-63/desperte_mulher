      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('Explore sem inserir dados reais.',
                style: AppTypography.bodyMedium),
            const SizedBox(height: AppSpacing.xxl),
            _DemoCard(
              icon: Icons.analytics_outlined,
              title: 'Simulação de Análise',
              description: 'Veja como funciona com dados fictícios.',
              onTap: () => context.go(AppRoutes.quiz),
            ),
            const SizedBox(height: AppSpacing.md),
            _DemoCard(
              icon: Icons.bar_chart,
              title: 'Resultado — Nível Alto',
              description: 'Visualize um exemplo de resultado com risco Alto.',
